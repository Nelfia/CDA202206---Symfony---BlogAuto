 ...
 */
final class Version20221208131548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE auhtor_id author_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE author_id auhtor_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE annonce ADD CONSTRAINT FK_F65593E5221FC741 FOREIGN KEY (auhtor_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
